...
def project_point(camera, point_3d):
    ...
    # broadcasting the extrinsic matrix for later computation
    if extrinsic_matrix.shape[0] < point_3d.shape[0]:
        num_p = point_3d.shape[0]
        extrinsic_matrix = extrinsic_matrix.expand(num_p, -1, -1)
    ...
    if intrinsic_matrix.shape[0] < point_3d.shape[0]:
        num_p = point_3d.shape[0]
        intrinsic_matrix = intrinsic_matrix.expand(num_p, -1, -1)
